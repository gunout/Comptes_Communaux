...
class TroisBassinsFinanceAnalyzer:
    def __init__(self):
        self.commune = "Trois-Bassins"
    ...
    def generate_financial_data(self):
        """Génère des données financières pour la commune des Trois-Bassins"""
        ...
        # Données démographiques (Trois-Bassins est moins peuplée)
        ...
        # Investissements spécifiques (adaptés aux Trois-Bassins)
        ...
        # Ajouter des tendances spécifiques aux Trois-Bassins
        self._add_municipal_trends(df)
        
        return df
    
    def _simulate_population(self, dates):
        """Simule la population des Trois-Bassins (moins peuplée)"""
    ...
    def _simulate_tourism_investment(self, dates):
        """Simule l'investissement touristique (spécifique aux Trois-Bassins)"""
    ...
    def _simulate_environment_investment(self, dates):
        """Simule l'investissement environnemental (spécifique aux Trois-Bassins)"""
    ...
    def _simulate_equipment_investment(self, dates):
        ...
        for i, date in enumerate(dates):
            year = date.year
            if year in [2005, 2010, 2015, 2020, 2024]:  # Investissements en équipements
                multiplier = 1.6
            else:
                multiplier = 1.0
    ...
    def _add_municipal_trends(self, df):
        """Ajoute des tendances municipales réalistes pour Les Trois-Bassins"""
        for i, row in df.iterrows():
            ...
            if year >= 2012:
                culture_growth = 1 + 0.022 * (year - 2012)
                df.loc[i, 'Investissement_Culture'] *= culture_growth
            
            # Développement environnemental (spécificité des Trois-Bassins)
            if year >= 2010:
            ...
            if year >= 2022:
                ...
                df.loc[i, 'Investissement_Environnement'] *= 1.15
    ...
    def create_financial_analysis(self, df):
        ...
        plt.suptitle(f'Analyse des Comptes Communaux des Trois-Bassins ({self.start_year}-{self.end_year})', 
                    fontsize=16, fontweight='bold')
        plt.tight_layout()
        plt.savefig('trois_bassins_financial_analysis.png', dpi=300, bbox_inches='tight')
        plt.show()
    ...
    def _plot_sectorial_investments(self, df, ax):
        ...
        categories = ['Investissement_Tourisme', 'Investissement_Agriculture', 
                     'Investissement_Environnement', 'Investissement_Culture', 'Investissement_Equipements']
        colors = ['#264653', '#2A9D8F', '#E76F51', '#F9A602', '#6A0572']
        labels = ['Tourisme', 'Agriculture', 'Environnement', 'Culture', 'Équipements']
    ...
    def _generate_financial_insights(self, df):
        ...
        print(f"🏛️ INSIGHTS ANALYTIQUES - Commune des Trois-Bassins")
        print("=" * 60)
        ...
        # 5. Spécificités des Trois-Bassins
        ...
        print("• 2006-2007: Développement des infrastructures touristiques")
        print("• 2008-2009: Impact de la crise financière mondiale")
        print("• 2010-2015: Développement du tourisme et de l'environnement")
        ...
        print("• Capitaliser sur les atouts naturels (cirques, forêts, cascades)")
        print("• Développer un tourisme durable et respectueux de l'environnement")
        print("• Valoriser le patrimoine culturel et artisanal")
        print("• Maintenir une politique environnementale ambitieuse")
        print("• Diversifier l'économie au-delà du tourisme")
        print("• Améliorer l'accessibilité de la commune")
        print("• Développer l'agriculture biologique et les produits locaux")

def main():
    """Fonction principale"""
    print("🏛️ ANALYSE DES COMPTES COMMUNAUX DES TROIS-BASSINS (2002-2025)")
    print("=" * 60)
    
    # Initialiser l'analyseur
    analyzer = TroisBassinsFinanceAnalyzer()
    
    # Générer les données
    financial_data = analyzer.generate_financial_data()
    
    # Sauvegarder les données
    output_file = 'trois_bassins_financial_data_2002_2025.csv'
    ...
    print(f"\n✅ Analyse des comptes communaux des Trois-Bassins terminée!")
    print(f"📊 Période: {analyzer.start_year}-{analyzer.end_year}")
    print("📦 Données: Démographie, finances, investissements, dette")
    print("🌴 Spécificité: Focus sur le tourisme et l'environnement")
