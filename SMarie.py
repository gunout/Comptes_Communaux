...
class SainteMarieFinanceAnalyzer:
    def __init__(self):
        self.commune = "Sainte-Marie"
    ...
    def generate_financial_data(self):
        """Génère des données financières pour la commune de Sainte-Marie"""
        print("🏛️ Génération des données financières pour Sainte-Marie...")
        ...
        # Données démographiques (Sainte-Marie est moins peuplée)
        ...
        # Investissements spécifiques (adaptés à Sainte-Marie)
        ...
        # Ajouter des tendances spécifiques à Sainte-Marie
        self._add_municipal_trends(df)
        
        return df
    
    def _simulate_population(self, dates):
        """Simule la population de Sainte-Marie"""
    ...
    def _simulate_total_revenue(self, dates):
        ...
        base_revenue = 35  # millions d'euros en 2002 (budget plus modeste)
    ...
    def _simulate_agriculture_investment(self, dates):
        """Simule l'investissement agricole (spécifique à Sainte-Marie)"""
    ...
    def _simulate_tourism_investment(self, dates):
        """Simule l'investissement touristique (spécifique à Sainte-Marie)"""
    ...
    def _simulate_culture_investment(self, dates):
        """Simule l'investissement culturel (spécifique à Sainte-Marie)"""
    ...
    def _add_municipal_trends(self, df):
        """Ajoute des tendances municipales réalistes pour Sainte-Marie"""
        for i, row in df.iterrows():
            ...
            # Développement touristique accéléré (2010-2015)
                ...
                df.loc[i, 'Investissement_Tourisme'] *= 1.3
                df.loc[i, 'Investissement_Culture'] *= 1.4
            ...
            # Développement agricole (spécifique à Sainte-Marie)
            if year >= 2010:
            ...
            if year >= 2022:
                ...
                df.loc[i, 'Investissement_Culture'] *= 1.15
    ...
    def create_financial_analysis(self, df):
        ...
        plt.suptitle(f'Analyse des Comptes Communaux de Sainte-Marie ({self.start_year}-{self.end_year})', 
                    fontsize=16, fontweight='bold')
        plt.tight_layout()
        plt.savefig('sainte_marie_financial_analysis.png', dpi=300, bbox_inches='tight')
        plt.show()
    ...
    def _plot_sectorial_investments(self, df, ax):
        ...
        categories = ['Investissement_Agriculture', 'Investissement_Tourisme', 
                     'Investissement_Transport', 'Investissement_Education', 'Investissement_Culture']
        colors = ['#264653', '#2A9D8F', '#E76F51', '#F9A602', '#6A0572']
        labels = ['Agriculture', 'Tourisme', 'Transport', 'Éducation', 'Culture']
    ...
    def _generate_financial_insights(self, df):
        ...
        print(f"🏛️ INSIGHTS ANALYTIQUES - Commune de Sainte-Marie")
        print("=" * 60)
        ...
        # 5. Spécificités de Sainte-Marie
        print("\n5. 🌴 SPÉCIFICITÉS COMMUNALES:")
        avg_tourism_investment = df['Investissement_Tourisme'].mean()
        avg_culture_investment = df['Investissement_Culture'].mean()
        tourism_share = (df['Investissement_Tourisme'].mean() / df['Investissement'].mean()) * 100
        culture_share = (df['Investissement_Culture'].mean() / df['Investissement'].mean()) * 100
        
        print(f"Investissement touristique moyen: {avg_tourism_investment:.2f} M€")
        print(f"Investissement culturel moyen: {avg_culture_investment:.2f} M€")
        print(f"Part du tourisme dans l'investissement: {tourism_share:.1f}%")
        print(f"Part de la culture dans l'investissement: {culture_share:.1f}%")
        ...
        print("• 2010-2015: Développement des infrastructures touristiques et culturelles")
        print("• 2020-2021: Gestion de la crise COVID-19 (impact sur le tourisme)")
        print("• 2022-2025: Plan de relance post-COVID axé sur le tourisme et la culture")
        
        # 7. Recommandations
        print("\n7. 💡 RECOMMANDATIONS STRATÉGIQUES:")
        print("• Capitaliser sur les atouts touristiques (plages, sites culturels)")
        print("• Développer l'agriculture locale (vanille, fruits tropicaux)")
        print("• Renforcer l'offre culturelle (musées, événements)")
...
def main():
    """Fonction principale"""
    print("🏛️ ANALYSE DES COMPTES COMMUNAUX DE SAINTE-MARIE (2002-2025)")
    print("=" * 60)
    
    # Initialiser l'analyseur
    analyzer = SainteMarieFinanceAnalyzer()
    
    # Générer les données
    financial_data = analyzer.generate_financial_data()
    
    # Sauvegarder les données
    output_file = 'sainte_marie_financial_data_2002_2025.csv'
    ...
    print(f"\n✅ Analyse des comptes communaux de Sainte-Marie terminée!")
    print(f"📊 Période: {analyzer.start_year}-{analyzer.end_year}")
    print("📦 Données: Démographie, finances, investissements, dette")
    print("🌴 Spécificité: Focus sur les investissements touristiques et culturels")
