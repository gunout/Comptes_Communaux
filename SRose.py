...
class SainteRoseFinanceAnalyzer:
    def __init__(self):
        self.commune = "Sainte-Rose"
    ...
    def generate_financial_data(self):
        """Génère des données financières pour la commune de Sainte-Rose"""
        print("🏛️ Génération des données financières pour Sainte-Rose...")
        ...
        # Données démographiques (Sainte-Rose est moins peuplée)
        ...
        # Investissements spécifiques (adaptés à Sainte-Rose)
        ...
        # Ajouter des tendances spécifiques à Sainte-Rose
        self._add_municipal_trends(df)
        
        return df
    
    def _simulate_population(self, dates):
        """Simule la population de Sainte-Rose (moins peuplée que Saint-Paul)"""
        base_population = 6500  # population estimée en 2002
    ...
    def _simulate_households(self, dates):
        ...
        base_households = 2200  # ménages en 2002
    ...
    def _simulate_total_revenue(self, dates):
        ...
        base_revenue = 12  # millions d'euros en 2002 (budget plus modeste)
    ...
    def _simulate_state_grants(self, dates):
        ...
        base_grants = 5  # millions d'euros en 2002
    ...
    def _simulate_other_revenue(self, dates):
        ...
        base_other = 2  # millions d'euros en 2002
    ...
    def _simulate_debt_charges(self, dates):
        ...
        base_debt_charge = 0.8  # millions d'euros en 2002
    ...
    def _simulate_gross_savings(self, dates):
        ...
        for i, date in enumerate(dates):
            ...
            base_saving = 0.6  # millions d'euros en 2002
    ...
    def _simulate_agriculture_investment(self, dates):
        """Simule l'investissement agricole (spécifique à Sainte-Rose)"""
        base_investment = 0.6  # millions d'euros en 2002
    ...
    def _simulate_tourism_investment(self, dates):
        """Simule l'investissement touristique (spécifique à Sainte-Rose)"""
    ...
    def _simulate_transport_investment(self, dates):
        ...
        base_investment = 0.7  # millions d'euros en 2002
    ...
    def _simulate_health_investment(self, dates):
        ...
        base_investment = 0.4  # millions d'euros en 2002
    ...
    def _simulate_environment_investment(self, dates):
        """Simule l'investissement environnemental (spécifique à Sainte-Rose)"""
        base_investment = 0.3  # millions d'euros en 2002
        
        investment = []
        for i, date in enumerate(dates):
            year = date.year
            if year in [2009, 2014, 2019, 2024]:  # Gros investissements environnementaux
                multiplier = 2.2
            else:
                multiplier = 1.0
    ...
    def _add_municipal_trends(self, df):
        """Ajoute des tendances municipales réalistes pour Sainte-Rose"""
        for i, row in df.iterrows():
            ...
            # Développement économique accéléré (2010-2015)
                ...
                df.loc[i, 'Population'] *= 1.01  # Croissance démographique modérée
            ...
            if year >= 2022:
                ...
                df.loc[i, 'Investissement_Tourisme'] *= 1.25
                df.loc[i, 'Investissement_Environnement'] *= 1.2
    ...
    def create_financial_analysis(self, df):
        ...
        plt.suptitle(f'Analyse des Comptes Communaux de Sainte-Rose ({self.start_year}-{self.end_year})', 
                    fontsize=16, fontweight='bold')
        plt.tight_layout()
        plt.savefig('sainte_rose_financial_analysis.png', dpi=300, bbox_inches='tight')
        plt.show()
    ...
    def _plot_sectorial_investments(self, df, ax):
        ...
        labels = ['Agriculture', 'Tourisme', 'Transport', 'Éducation', 'Santé', 'Environnement']
    ...
    def _generate_financial_insights(self, df):
        ...
        print(f"🏛️ INSIGHTS ANALYTIQUES - Commune de Sainte-Rose")
        print("=" * 60)
        ...
        # 5. Spécificités de Sainte-Rose
        print("\n5. 🌾 SPÉCIFICITÉS COMMUNALES:")
        avg_tourism_investment = df['Investissement_Tourisme'].mean()
        avg_environment_investment = df['Investissement_Environnement'].mean()
        tourism_share = (df['Investissement_Tourisme'].mean() / df['Investissement'].mean()) * 100
        environment_share = (df['Investissement_Environnement'].mean() / df['Investissement'].mean()) * 100
        
        print(f"Investissement touristique moyen: {avg_tourism_investment:.2f} M€")
        print(f"Investissement environnemental moyen: {avg_environment_investment:.2f} M€")
        print(f"Part du tourisme dans l'investissement: {tourism_share:.1f}%")
        print(f"Part de l'environnement dans l'investissement: {environment_share:.1f}%")
        ...
        print("• 2010-2015: Développement des infrastructures touristiques et environnementales")
        print("• 2020-2021: Fort impact de la crise COVID-19 sur le tourisme")
        print("• 2022-2025: Plan de relance post-COVID axé sur le tourisme et l'environnement")
        
        # 7. Recommandations
        print("\n7. 💡 RECOMMANDATIONS STRATÉGIQUES:")
        print("• Capitaliser sur les atouts naturels (Piton de la Fournaise, cascades)")
        print("• Développer l'écotourisme et le tourisme d'aventure")
        print("• Valoriser les productions agricoles locales (vanille, fruits tropicaux)")
        print("• Renforcer les infrastructures d'accueil touristique")
        print("• Préserver les espaces naturels et la biodiversité")
        print("• Améliorer l'accessibilité de la commune (routes, transports)")
        print("• Diversifier l'économie locale au-delà du tourisme")

def main():
    """Fonction principale"""
    print("🏛️ ANALYSE DES COMPTES COMMUNAUX DE SAINTE-ROSE (2002-2025)")
    print("=" * 60)
    
    # Initialiser l'analyseur
    analyzer = SainteRoseFinanceAnalyzer()
    
    # Générer les données
    financial_data = analyzer.generate_financial_data()
    
    # Sauvegarder les données
    output_file = 'sainte_rose_financial_data_2002_2025.csv'
    ...
    print(f"\n✅ Analyse des comptes communaux de Sainte-Rose terminée!")
    print(f"📊 Période: {analyzer.start_year}-{analyzer.end_year}")
    print("📦 Données: Démographie, finances, investissements, dette")
    print("🌿 Spécificité: Focus sur les investissements touristiques, agricoles et environnementaux")
